...
function ShoppingCart() {
  const { shoppingCart, changeShoppingCart, removeItemShoppingCart } =
    useProducts();
  ...
  function onHandleChange(id, quantity) {
      ...
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          <div className="flex justify-between border-b pb-8">
            ...
            <h2 className="font-semibold text-2xl">{shoppingCart.length} Items</h2>
          </div>
            ...
            shoppingCart.map((product) => (
              ...
              >
                <div className="flex w-2/5">
                  <div className="w-20">
                    <img className="h-24" src={product.image[0]} alt="" />
                  </div>
                ...
                <div className="flex justify-center w-1/5">
                  <svg
                    ...
                    viewBox="0 0 448 512"
                    onClick={() =>
                      onHandleChange(product._id, product.quantity - 1)
                    }
                  >
        ...
        <div id="summary" className="w-1/4 px-8 py-10 bg-gray-300">
          ...
          <div className="border-t mt-8">
            <div className="flex font-semibold justify-between py-6 text-sm uppercase">
              ...
              <span>{getCartTotal(shoppingCart) + 20} €</span>
            </div>
            {!isAuth ? (
              <Link to="/signin">
                <button
